...
def app():
    ...
    st.markdown("📖 هنا تقدر تختار السورة والآية اللي عايز تعرف تفسيرها، ورفيق القرآن هيجيب لك التفسير بطريقة واضحة وسهلة، وكمان تقدر تحفظ التفسير بصيغة CSV . استمتع بالمعرفة والتدبر✨", unsafe_allow_html=True)
